...
export default function EducationExperience({
	...
	let userEducationInfo = userData.educationInfo[positionId];
	...
	return (
		<>
			<div className="form-group">
				...
				<input
					type="text"
					id={`${positionId}.gradeOfStudies.educationInfo`}
			...
			<div className="form-group">
				<label htmlFor={`${positionId}.areaOfStudies.educationInfo`}>Area of Studies</label> <br />
				<input
					type="text"
					id={`${positionId}.areaOfStudies.educationInfo`}
			...
			<div className="form-group">
				<label htmlFor={`${positionId}.institution.educationInfo`}>Institution</label> <br />
                <input
					type="text"
					id={`${positionId}.institution.educationInfo`}
			...
			<div className="form-group">
				<label htmlFor={`${positionId}.country.educationInfo`}>Country</label> <br />
                <select
					name={`educationInfo.country.${positionId}`}
					id={`${positionId}.country.educationInfo`}
                    value={userEducationInfo.country}
					onChange={onChange}
					required
				>
			...
			<div className="form-group">
				<label htmlFor={`${positionId}.city.educationInfo`}>City</label> <br />
                <input
					type="text"
					id={`${positionId}.city.educationInfo`}
