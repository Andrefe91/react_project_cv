    ...
    return (
        <>
            ...
            <div className="form-group">
                ...
                <input type="text" id="title" name="personalInfo.title" value={userData.personalInfo.title} onChange={onChange} required/>
            </div>
            ...
            <div className="form-group">
                ...
                <input type="tel" id="phone" name="personalInfo.phone" value={userData.personalInfo.phone} onChange={onChange} required/>
            </div>

            <div className="form-group">
                <label htmlFor="gender">Gender: </label>
                    <select name="personalInfo.gender" id="gender" value={userData.personalInfo.gender} onChange={onChange} required>
            ...
            <div className="form-group">
                ...
                <select name="personalInfo.nationality" id="nationality" value={userData.personalInfo.nationality} onChange={onChange} required>
